...
public class TextRunnerTest extends TestCase {
	...
	public void testFailure() throws Exception {
		execTest("junit.junit.tests.junit.framework.Failure", false);
	}

	public void testSuccess() throws Exception {
		execTest("junit.junit.tests.junit.framework.Success", true);
	}

	public void testError() throws Exception {
		execTest("junit.junit.tests.BogusDude", false);
	}
	...
	void execTest(String testClass, boolean success) throws Exception {
		...
		String [] cmd= { java, "-classpath", cp, "junit.junit.textui.TestRunner", testClass};
